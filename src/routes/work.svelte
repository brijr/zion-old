...
<section class="flex gap-4">
    <a class="w-fit pb-2 pt-12 block flex border-b hover:text-[#C7CEFF] hover:border-[#C7CEFF]" href="https://tally.so/r/31A6rQ">
    ...
    <a class="w-fit pb-2 pt-12 flex block border-b hover:text-[#C7CEFF] hover:border-[#C7CEFF]" href="https://dribbble.com/brijr">
